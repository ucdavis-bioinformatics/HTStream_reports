...
working_dir = "/share/biocore/joshi/projects/SantaMaria_S_Nasa/April_2019_Yeast_RNA-Seq_part_2"
...
if ("SeqScreener Recorded Contaminants" %in% colnames(final_stats)) {
    ...
    p1 <- ggplot() + 
      ...
      geom_point(data=dffs1, aes(x=x,y=y))
    ...
    p2 <- ggplot() + 
      ...
      geom_point(data=dffs2, aes(x=x,y=y))
