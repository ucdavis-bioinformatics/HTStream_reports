...
```{r setup}
knitr::opts_knit$set(root.dir = "/share/biocore/joshi/projects/Iyer_S_UCD/2018_Rhesus_Batch_TagSeq")
```

```{r}

### SETTINGS ###
working_dir = "/share/biocore/joshi/projects/Iyer_S_UCD/2018_Rhesus_Batch_TagSeq"
...
colnames(final_stats) = c(cnames,"Uniquely Mapped Reads","Uniquely Mapped Perc","Multi-Mapped Reads","Multi-Mapped Perc","Reads Mapped to Genes","Perc Reads Mapped to Genes")
