---
title: "Preproc mapping stats for Oblessuc Pph transcriptome"
...
working_dir = "/share/biocore/joshi/projects/Measles_Rhesus_Tag-Seq"
...
samples_file=""
# strandedness, 0 = deduce from counts, 1 = unstranded, 
# 2 = forward strand, 3 = reverse strand
strandcol = 0
######################
```
...
if (strandcol == 1) {
    ...
    strand_type = "forward strand"
} else if (strandcol == 3) {
    strand_type = "reverse strand"
}
write("**********CHECK IF CORRECT***************", stderr())
write(paste("Strandedness:",strand_type), stderr())
write("*****************************************", stderr())
